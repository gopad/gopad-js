 ...
 * @module gopad/model/Team
 * @version 1.0.0-alpha1
 */
class Team {
  /**
     * Constructs a new <code>Team</code>.
     * @alias module:gopad/model/Team
     * @param name {String}
     */
  constructor (name) {
  ...
  /**
     ...
     * @param {module:gopad/model/Team} obj Optional instance to populate.
     * @return {module:gopad/model/Team} The populated <code>Team</code> instance.
     */
