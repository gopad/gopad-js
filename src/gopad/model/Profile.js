 ...
 * @module gopad/model/Profile
 * @version 1.0.0-alpha1
 */
class Profile {
  /**
     * Constructs a new <code>Profile</code>.
     * @alias module:gopad/model/Profile
  ...
  /**
     ...
     * @param {module:gopad/model/Profile} obj Optional instance to populate.
     * @return {module:gopad/model/Profile} The populated <code>Profile</code> instance.
     */
