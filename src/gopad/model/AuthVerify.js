 ...
 * @module gopad/model/AuthVerify
 * @version 1.0.0-alpha1
 */
class AuthVerify {
  /**
     * Constructs a new <code>AuthVerify</code>.
     * @alias module:gopad/model/AuthVerify
  ...
  /**
     ...
     * @param {module:gopad/model/AuthVerify} obj Optional instance to populate.
     * @return {module:gopad/model/AuthVerify} The populated <code>AuthVerify</code> instance.
     */
