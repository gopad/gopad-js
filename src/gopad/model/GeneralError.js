 ...
 * @module gopad/model/GeneralError
...
class GeneralError {
  /**
     ...
     * @alias module:gopad/model/GeneralError
     * @param status {Number}
  ...
  /**
     ...
     * @param {module:gopad/model/GeneralError} obj Optional instance to populate.
     * @return {module:gopad/model/GeneralError} The populated <code>GeneralError</code> instance.
     */
