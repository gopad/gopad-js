 ...
 * @module gopad/model/UserTeamParams
 * @version 1.0.0-alpha1
 */
class UserTeamParams {
  /**
     * Constructs a new <code>UserTeamParams</code>.
     * @alias module:gopad/model/UserTeamParams
     * @param team {String}
     * @param perm {module:gopad/model/UserTeamParams.PermEnum}
     */
  ...
  /**
     ...
     * @param {module:gopad/model/UserTeamParams} obj Optional instance to populate.
     * @return {module:gopad/model/UserTeamParams} The populated <code>UserTeamParams</code> instance.
     */
...
/**
 * @member {module:gopad/model/UserTeamParams.PermEnum} perm
 */
