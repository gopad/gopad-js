 ...
 * @module gopad/model/ValidationErrorErrors
 * @version 1.0.0-alpha1
 */
class ValidationErrorErrors {
  /**
     * Constructs a new <code>ValidationErrorErrors</code>.
     * @alias module:gopad/model/ValidationErrorErrors
     */
  constructor () {
  ...
  /**
     ...
     * @param {module:gopad/model/ValidationErrorErrors} obj Optional instance to populate.
     * @return {module:gopad/model/ValidationErrorErrors} The populated <code>ValidationErrorErrors</code> instance.
     */
