 ...
 * @module gopad/model/ValidationError
...
class ValidationError {
  /**
     ...
     * @alias module:gopad/model/ValidationError
     * @param status {Number}
  ...
  /**
     ...
     * @param {module:gopad/model/ValidationError} obj Optional instance to populate.
     * @return {module:gopad/model/ValidationError} The populated <code>ValidationError</code> instance.
     */
...
/**
 * @member {Array.<module:gopad/model/ValidationErrorErrors>} errors
 */
