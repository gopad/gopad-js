 ...
 * @module gopad/model/AuthToken
 * @version 1.0.0-alpha1
 */
class AuthToken {
  /**
     * Constructs a new <code>AuthToken</code>.
     * @alias module:gopad/model/AuthToken
     * @param token {String}
  ...
  /**
     ...
     * @param {module:gopad/model/AuthToken} obj Optional instance to populate.
     * @return {module:gopad/model/AuthToken} The populated <code>AuthToken</code> instance.
     */
