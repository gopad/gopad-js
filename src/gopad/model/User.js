 ...
 * @module gopad/model/User
 * @version 1.0.0-alpha1
 */
class User {
  /**
     * Constructs a new <code>User</code>.
     * @alias module:gopad/model/User
  ...
  /**
     ...
     * @param {module:gopad/model/User} obj Optional instance to populate.
     * @return {module:gopad/model/User} The populated <code>User</code> instance.
     */
