...
/**
* Auth service.
* @module gopad/api/AuthApi
* @version 1.0.0-alpha1
*/
export default class AuthApi {
  /**
    * Constructs a new AuthApi.
    * @alias module:gopad/api/AuthApi
    * @class
  ...
  /**
     ...
     * @param {module:gopad/model/AuthLogin} authLogin The credentials to authenticate
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:gopad/model/AuthToken} and HTTP response
     */
  ...
  /**
     * Authenticate an user by credentials
     * @param {module:gopad/model/AuthLogin} authLogin The credentials to authenticate
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:gopad/model/AuthToken}
     */
  loginUser (authLogin) {
  ...
  /**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:gopad/model/AuthVerify} and HTTP response
     */
  ...
  /**
     * Verify validity for an authentication token
     * @param {String} token A token that have to be checked
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:gopad/model/AuthVerify}
     */
  verifyAuth (token) {
