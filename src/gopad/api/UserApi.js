...
/**
* User service.
* @module gopad/api/UserApi
* @version 1.0.0-alpha1
*/
export default class UserApi {
  /**
    * Constructs a new UserApi.
    * @alias module:gopad/api/UserApi
    * @class
    * @param {module:gopad/ApiClient} [apiClient] Optional API client implementation to use,
    * default to {@link module:gopad/ApiClient#instance} if unspecified.
    */
  ...
  /**
     ...
     * @param {module:gopad/model/UserTeamParams} userTeam The user team data to assign
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:gopad/model/GeneralError} and HTTP response
     */
  ...
  /**
     ...
     * @param {String} userId A user UUID or slug
     * @param {module:gopad/model/UserTeamParams} userTeam The user team data to assign
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:gopad/model/GeneralError}
     */
  ...
  /**
     * Create a new user
     * @param {module:gopad/model/User} user The user data to create
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:gopad/model/User} and HTTP response
     */
  ...
  /**
     * Create a new user
     * @param {module:gopad/model/User} user The user data to create
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:gopad/model/User}
     */
  createUser (user) {
  ...
  /**
     ...
     * @param {String} userId A user UUID or slug
     * @param {module:gopad/model/UserTeamParams} userTeam The user team data to delete
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:gopad/model/GeneralError} and HTTP response
     */
  ...
  /**
     ...
     * @param {String} userId A user UUID or slug
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:gopad/model/TeamUser>} and HTTP response
     */
  ...
  /**
     * Fetch all teams assigned to user
     * @param {String} userId A user UUID or slug
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:gopad/model/TeamUser>}
     */
  ...
  /**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:gopad/model/User>} and HTTP response
     */
  ...
  /**
     * Fetch all available users
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:gopad/model/User>}
     */
  listUsers () {
  ...
  /**
     ...
     * @param {String} userId A user UUID or slug
     * @param {module:gopad/model/UserTeamParams} userTeam The user team data to update
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:gopad/model/GeneralError} and HTTP response
     */
  ...
  /**
     ...
     * @param {String} userId A user UUID or slug
     * @param {module:gopad/model/User} user The user data to update
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:gopad/model/User} and HTTP response
     */
